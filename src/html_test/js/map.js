Map = function(container, proj) {
  ...
  // this.addPattern('tile-asphalt', 'images/asphalt.jpg', 320, 320);
...
Map.prototype.zoomTo = function(feature, duration, percentPad) {
  ...
  this.g.transition().duration(duration).attr("transform", scale + transform);
}
